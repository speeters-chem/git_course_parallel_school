...
- 2.1.9 Tl and ODs change the same line of the same file on their local repos
- 2.1.10 TL commits and pushes his change on his remote repo.
- 2.1.11 ODs pull from TL's remote repo and manage the conflict
- 2.1.12 --**CHECK**-- if all repos are syncronized
- 2.1.13 ODs change the same line of the same file, commit and push on their remote repos
- 2.1.14 TL pulls from ODs' remote repos, chooses the correct change and manages the conflict
